...
between_subject_brushing_length_vs_child_sleep <- ggplot(data=data, mapping=aes(x=average_time_sleep, y=average_time_brushing))
...
between_subject_brushing_length_vs_encouragement <- ggplot(data=data, mapping=aes(x=average_encouragement, y=average_time_brushing))
...
between_subject_encouragement_vs_child_sleep <- ggplot(data=data, mapping=aes(x=average_time_sleep, y=average_encouragement))
...
between_subject_parent_stress_vs_child_sleep <- ggplot(data=data, mapping=aes(x=average_time_sleep, y=average_encouragement))
