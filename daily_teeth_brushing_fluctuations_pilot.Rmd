...
# exclude subject 115
daily_fluctuations<-daily_fluctuations[!grepl(115, data$subject),]
...
data$average_encouragement <- with(data, ave(encouragement, subject, FUN=function(x) mean(x, na.rm=TRUE)))
data$average_parent_stress <- with(data, ave(parent_stress, subject, FUN=function(x) mean(x, na.rm=TRUE)))
data$average_time_sleep <- with(data, ave(time_sleep, subject, FUN=function(x) mean(x, na.rm=TRUE)))
data$average_parent_mood <- with(data, ave(parent_mood, subject, FUN=function(x) mean(x, na.rm=TRUE)))
data$average_child_mood <- with(data, ave(child_mood, subject, FUN=function(x) mean(x, na.rm=TRUE)))
data$average_time_sleep_nonap <- with(data, ave(time_sleep_nonap, subject, FUN=function(x) mean(x, na.rm=TRUE)))

# shortened average data
# get specific average columns
average_data <- data %>% dplyr::select(average_time_brushing, average_encouragement,average_parent_stress, average_time_sleep, average_parent_mood, average_child_mood, average_time_sleep_nonap,pss_sum)

# only need one row for each user
average_data <- average_data[!duplicated(data$subject),]
```
...
within_subject_brushing_length_vs_sleep <- ggplot(data=data, mapping=aes(x=time_sleep, y=time_brushing, color=as.factor(subject)))
...
within_subject_child_sleep_vs_parent_stress <- ggplot(data=data, mapping=aes(x=parent_stress, y=time_sleep, color=as.factor(subject)))
...
within_subject_brushing_length_vs_parent_stress <- ggplot(data=data, mapping=aes(x=parent_stress, y=time_brushing, color=as.factor(subject)))
...
between_subject_brushing_length_vs_child_sleep <- ggplot(data=average_data, mapping=aes(x=average_time_sleep, y=average_time_brushing))
...
between_subject_brushing_length_vs_encouragement <- ggplot(data=average_data, mapping=aes(x=average_encouragement, y=average_time_brushing))
...
between_subject_encouragement_vs_child_sleep <- ggplot(data=average_data, mapping=aes(x=average_time_sleep, y=average_encouragement))
...
between_subject_parent_stress_vs_child_sleep <- ggplot(data=average_data, mapping=aes(x=average_time_sleep, y=average_parent_stress))
...
average_stress_vs_parent_perceived_stress <- ggplot(data=average_data, mapping=aes(x=pss_sum, y=average_parent_stress))
