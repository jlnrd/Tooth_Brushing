...
<p>
  Despite the expected relationship between brushing length and amount of sleep, only a few subject's brushing length significantly correlated with their sleep. Subjects 105 and 114 almost have statistically significant correlations, but subject 105's correlation is positive while subject 114's is negative. Subjects 117 and 118 have p < 0.05, but while subject 117 has a high positive correlation, subject 118 has a negative correlation. There doesn't seem to be a clear relationship between brushing length and sleep, atleast within this pilot study.
</p>
...
<p>
  The time brushing and encouragement histograms match expectations because longer brushing length and greater parental encouragement occur less frequently than shorter brushing length and lower parental encouragement. The 0.41 positive correlation between time brushing and encouragement is also statistically significant with a low p value. Meanwhile, parent stress and parent mood have the expected negative correlation shown by the frequencies of low parent stress and high parent mood. Parent mood and child mood have a positive correlation which connects to the negative correlation between parent stress and child mood. Lastly, time spent sleeping (including naps) has a normal distribution which would be expected. However, there does not seem to be a relationship between time spent sleeping and brushing length.
</p>
