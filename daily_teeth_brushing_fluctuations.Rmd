...
covariance_time_brushing <- standard_deviation_time_brushing/average_time_brushing
...
covariance_encouragements <- standard_deviation_encouragements/average_encouragements
...
covariance_parent_stress <- standard_deviation_parent_stress/average_parent_stress
...
covariance_time_sleep <- standard_deviation_time_sleep/average_time_sleep
...
covariance_parent_mood <- standard_deviation_parent_mood/average_parent_mood
...
covariance_child_mood <- standard_deviation_child_mood/average_child_mood
...
covariance_time_sleep_nonap <- standard_deviation_time_sleep_nonap/average_time_sleep_nonap

overall_subject <- data.frame("subject_ID" = subject, "mean_time_brushing" = average_time_brushing, "sd_time_brushing" = standard_deviation_time_brushing, "cov_time_brushing" = covariance_time_brushing, "mean_encouragements" = average_encouragements, "sd_encouragements" = standard_deviation_encouragements, "cov_encouragements" = covariance_encouragements, "mean_parent_stress" = average_parent_stress, "sd_parent_stress" = standard_deviation_parent_stress, "cov_parent_stress" = covariance_parent_stress, "mean_time_sleep" = average_time_sleep, "sd_time_sleep" = standard_deviation_time_sleep, "cov_time_sleep" = covariance_time_sleep, "mean_parent_mood" = average_parent_mood, "sd_parent_mood" = standard_deviation_parent_mood, "cov_parent_mood" = covariance_parent_mood, "mean_child_mood" = average_child_mood, "sd_child_mood" = standard_deviation_child_mood, "cov_child_mood" = covariance_child_mood, "mean_time_sleep_nonap" = average_time_sleep_nonap, "sd_time_sleep_nonap" = standard_deviation_time_sleep_nonap, "cov_time_sleep_nonap" = covariance_time_sleep_nonap)
...
#### Between Subject Correlation Matrix

```{r,warning=FALSE,fig.width=10, fig.height=8,echo = FALSE}
attach(overall_subject)
# cbind() combines two matrices that have the same number of rows together
between_subject_averages <- cbind(mean_time_brushing, mean_encouragements, mean_parent_stress, mean_parent_mood, mean_child_mood, mean_time_sleep, mean_time_sleep_nonap)
...
#### Between Subject Standard Deviation and Covariance
