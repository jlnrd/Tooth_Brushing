...
#### Correlation Matrix For All Valid Subjects
```{r,warning=FALSE,fig.width=10, fig.height=8,echo = FALSE}
...
between_subject_brushing_length_vs_encouragements <- ggplot(data=overall_subject, mapping=aes(x=average_encouragements, y=average_time_brushing))
...
between_subject_brushing_length_vs_child_sleep <- ggplot(data=overall_subject, mapping=aes(x=average_time_sleep, y=average_time_brushing))
...
between_subject_brushing_length_vs_child_mood <- ggplot(data=overall_subject, mapping=aes(x=average_child_mood, y=average_time_brushing))
...
# plot encouragements vs. child sleep
between_subject_encouragements_vs_time_sleep <- ggplot(data=overall_subject, mapping=aes(x=average_time_sleep, y=average_encouragements))
...
# plot encouragements vs. child mood
between_subject_encouragements_vs_child_mood <- ggplot(data=overall_subject, mapping=aes(x=average_child_mood, y=average_encouragements))
...
between_subject_averages <- cbind(average_time_brushing, average_encouragements, average_parent_stress, average_parent_mood, average_child_mood, average_time_sleep, average_parent_education, median_income, number_of_siblings, child_birth_weight, sum_pss)
